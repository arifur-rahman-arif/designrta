                ...
                y: {
                    title: {
                        formatter: function (value, { series, seriesIndex, dataPointIndex, w }) {
                            return project_status()[dataPointIndex];
                        }
                    }
                },
                marker: {
...
function project_count() {
    let count_arr = [];
    $.each(filtered_data.projects, function (index, value) {
        count_arr.push(value.project_count)
    });
    return count_arr;
}
...
function project_status() {
    let status_arr = [];
    $.each(filtered_data.projects, function (index, value) {
        status_arr.push(value.project_status)
    });
    return status_arr;
}
...
$(document).ready(function () {
    $(".in-progress-c").on('click', function () {
        $(".completed").hide();
        $(".in-revision").hide();
        $(".ready-for-approval").hide();
        $(".design-in-progress").siblings().hide();
        $(".design-in-progress").show();
    });

    $(".completed-c").on('click', function () {
        $(".in-revision").hide();
        $(".ready-for-approval").hide();
        $(".design-in-progress").hide();
        $(".completed").siblings().hide();
        $(".completed").show();
    });

    $(".in-revision-c").on('click', function () {
        $(".ready-for-approval").hide();
        $(".design-in-progress").hide();
        $(".completed").hide();
        $(".in-revision").siblings().hide();
        $(".in-revision").show();
    });

    $(".need-approval-c").on('click', function () {
        $(".design-in-progress").hide();
        $(".completed").hide();
        $(".in-revision").show();
        $(".ready-for-approval").siblings().hide();
        $(".ready-for-approval").show();
    });
});